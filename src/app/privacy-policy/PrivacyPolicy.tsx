...
import { SH1, SH2, SH3, SUl, SLi, SH4, SA, SLink } from '@/styles'
...
export const PrivacyPolicy = () => {
  return (
    <Container>
      <SH1>利用規約</SH1>
      <p>
        本利用規約は、<SLink href="/">Pokemonote</SLink>
      ...
      <SH2>個人情報の取得と利用目的</SH2>
      <p>
        当サイトで取得する訪問者の個人情報と利用目的、保存期間等は下記の通りです。
      </p>
      <SH3>お問い合わせされた個人情報を取得します</SH3>
      <p>
        当サイトでは
        <SLink href="/lefmarna-otoiawase">お問い合わせフォーム</SLink>
        を設けています。
      </p>
      <p>
      ...
      <SUl>
        <SLi>お問い合わせフォームに入力されたお名前</SLi>
        <SLi>お問い合わせフォームに入力されたメールアドレス</SLi>
        <SLi>お問い合わせフォームに入力されたお問い合わせ内容</SLi>
      </SUl>
      <SH4>利用目的について</SH4>
      <p>
      ...
      <SH3>当サイトで掲載している画像の著作権や肖像権等について</SH3>
      <p>
